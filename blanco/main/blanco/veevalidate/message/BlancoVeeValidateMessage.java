...
/**
 * blancoVeeValidateが利用するメッセージ。
 */
public class BlancoVeeValidateMessage {
    /**
     * メッセージをプロパティファイル対応させるための内部的に利用するリソースバンドルクラス。
     */
    protected final BlancoVeeValidateMessageResourceBundle fBundle = new BlancoVeeValidateMessageResourceBundle();

    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI07]の文字列を取得します。
     *
     * No.8:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJI08]の文字列を取得します。
     *
     * No.9:
    ...
    /**
     * メッセージ定義ID[BlancoVeeValidate]、キー[MBVOJA01]の文字列を取得します。
     *
     * No.10:
