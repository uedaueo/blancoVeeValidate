package blanco.veevalidate.message;
 ...
 */
class BlancoVeeValidateMessageResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoVeeValidateMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoVeeValidateMessage]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoVeeValidateMessageResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/veevalidate/message/BlancoVeeValidateMessage");
     ...
     * BlancoVeeValidateMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoVeeValidateMessage]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoVeeValidateMessageResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/veevalidate/message/BlancoVeeValidateMessage", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoVeeValidateMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoVeeValidateMessage]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoVeeValidateMessageResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/veevalidate/message/BlancoVeeValidateMessage", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI01]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI02]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI03]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI04]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI05]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI06]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI07]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJI08]
     *
    ...
    /**
     * bundle[BlancoVeeValidateMessage], key[MBVOJA01]
     *
