...
/**
 * Batch process class [BlancoVeeValidateBatchProcess].
 *
 * <P>Example of a batch processing call.</P>
 * <code>
 * java -classpath (classpath) blanco.veevalidate.task.BlancoVeeValidateBatchProcess -help
 * </code>
 */
public class BlancoVeeValidateBatchProcess {
    ...
    public static final void main(final String[] args) {
        ...
        for (int index = 0; index < args.length; index++) {
            ...
            if (arg.startsWith("-verbose=")) {
                ...
                try {
                    ...
                    System.out.println("BlancoVeeValidateBatchProcess: Failed to start the process. Tried to parse the field [tabs] of the input parameter[input] as a number (int), but it failed.: " + e.toString());
                ...
                System.out.println("BlancoVeeValidateBatchProcess: The input parameter[" + arg + "] was ignored.");
                isNeedUsage = true;
            }
        }
        ...
        if( isFieldMetadirProcessed == false) {
            System.out.println("BlancoVeeValidateBatchProcess: Failed to start the process. The required field value[metadir] in the input parameter[input] is not set to a value.");
            System.exit(END_ILLEGAL_ARGUMENT_EXCEPTION);
        }
    ...
    public int process(final BlancoVeeValidateProcessInput input) throws IOException, IllegalArgumentException {
        ...
        // If you get a compile error at this point, You may be able to solve it by implementing a BlancoVeeValidateProcess interface and creating an BlancoVeeValidateProcessImpl class in package blanco.veevalidate.task.
    ...
    public final int execute(final BlancoVeeValidateProcessInput input) throws IllegalArgumentException {
        try {
            ...
            System.out.println("BlancoVeeValidateBatchProcess: An input exception has occurred. Abort the batch process.:" + ex.toString());
            // Termination due to abnormal input.
            return END_ILLEGAL_ARGUMENT_EXCEPTION;
        } catch (IOException ex) {
            System.out.println("BlancoVeeValidateBatchProcess: An I/O exception has occurred. Abort the batch process.:" + ex.toString());
            // Termination due to abnormal input.
            return END_IO_EXCEPTION;
        } catch (RuntimeException ex) {
            System.out.println("BlancoVeeValidateBatchProcess: A runtime exception has occurred. Abort the batch process.:" + ex.toString());
            ex.printStackTrace();
            // Abnormal end.
            return END_ERROR;
        } catch (Error er) {
            System.out.println("BlancoVeeValidateBatchProcess: A runtime exception has occurred. Abort the batch process.:" + er.toString());
            er.printStackTrace();
            // Abnormal end.
            return END_ERROR;
        }
    ...
    public static final void usage() {
        ...
        System.out.println("  java blanco.veevalidate.task.BlancoVeeValidateBatchProcess -verbose=value1 -metadir=value2 -targetdir=value3 -tmpdir=value4 -encoding=value5 -tabs=value6 -xmlrootelement=value7 -sheetType=value8 -targetStyle=value9 -lineSeparator=value10 -searchTmpdir=value11");
    ...
    public void validateInput(final BlancoVeeValidateProcessInput input) throws IllegalArgumentException {
        ...
        if (input.getMetadir() == null) {
            throw new IllegalArgumentException("BlancoVeeValidateBatchProcess: Failed to start the process. The required field value[metadir] in the input parameter[input] is not set to a value.");
        }
    }
}
